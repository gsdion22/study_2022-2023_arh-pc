...
Программы будут выводить значения, записанные в регистр eax. (рис. [-@fig:003], [-@fig:002])
...
Исправьте текст программы (Листинг 1) следующим образом: (рис. [-@fig:005], [-@fig:009])
...
Преобразуем текст программы из Листинга 7.1 с использованием этих функций. (рис. [-@fig:006], [-@fig:007])

![Пример программы](image/6.png){ #fig:006 width=70%, height=70% }

![Работа программы](image/7.png){ #fig:007 width=70%, height=70% }
...
5. Аналогично предыдущему примеру изменим символы на числа. (рис. [-@fig:004], [-@fig:008])

Создайте исполняемый файл и запустите его. 
Какой результат будет получен при исполнении программы? – получили число 10

![Пример программы](image/4.png){ #fig:004 width=70%, height=70% }
...
Чем отличается вывод функций iprintLF и iprint? - Вывод отличается что нет переноса строки. (рис. [-@fig:008])
...
номеру студенческого билета, работающую по следующему алгоритму: (рис. [-@fig:015], рис. [-@fig:014])

![Пример программы](image/15.png){ #fig:015 width=70%, height=70% }

![Работа программы](image/14.png){ #fig:014 width=70%, height=70% }
...
Создайте исполняемый файл и проверьте его работу для значений x1 и x2 из 6.3. (рис. [-@fig:017], рис. [-@fig:016])

Получили вариант 15 - $$(5 + 𝑥)2 − 3$$  для х=5 и 1

![Пример программы](image/17.png){ #fig:017 width=70%, height=70% }

![Работа программы](image/16.png){ #fig:016 width=70%, height=70% }

# Выводы

В заключение хочу сказать, что эта лаборатория позволила нам научиться работать с арифметическими операциями.
