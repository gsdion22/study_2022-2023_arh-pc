...
фрагментов кода. Общий формат огражденных блоков кода: language
...
![Название рисунка](image/рис.1.png) 
**Процедура установки teX live**

![Название рисунка](image/рис.2.png) 
**становка Pandoc и pandoc-crossref**

![Название рисунка](image/рис.3.png)
**Скачать архивы с исходными файлами.**

![Название рисунка](image/рис.4.png)
**Скопировать файлы pandoc и pandoc-crossref в каталог /usr/local/bin/:**

![Название рисунка](image/рис.6.png)
**C помощью команды ls можно проверить корректность выполненных дей-ствий**
