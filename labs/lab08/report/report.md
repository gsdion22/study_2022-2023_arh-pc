...
![Файл lab8-1.asm:](image/4.png){ #fig:004 width=70%, height=70% }
...
![Файл lab8-2.asm](image/6.png){ #fig:006 width=70%, height=70% }
...
листинга (рис. [-@fig:008],[-@fig:009])

![ошибка трансляции lab8-2](image/20.png){ #fig:020 width=70%, height=70% }

![файл листинга с ошибкой lab8-2](image/23.png){ #fig:023 width=70%, height=70% }
...
с вариантом, полученным при выполнении лабораторной работы № 7.
Создайте исполняемый файл и проверьте его работу (рис. [-@fig:010],[-@fig:011])
...
![Файл lab8-4.asm](image/25.png){ #fig:025 width=70%, height=70% }

![Программа lab8-4.asm](image/12.png){ #fig:012 width=70%, height=70% }

# Выводы

В окончательном варианте мы изучили команды условного и безусловного перехода и познакомились с файлом листинга.
